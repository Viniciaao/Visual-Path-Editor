...
t.test('parseHexColor aceita #RRGGBB e #AARRGGBB e recusa o resto', function()
		t.eq(util.parseHexColor('#ff0000'), '#FF0000')
		t.eq(util.parseHexColor('00FF00'), '#00FF00')
		t.eq(util.parseHexColor('  #80FF0000 '), '#80FF0000')
		t.eq(util.parseHexColor('azul'), nil)
		t.eq(util.parseHexColor('#12345'), nil)
		t.eq(util.parseHexColor('#GGGGGG'), nil)
		t.eq(util.parseHexColor(nil), nil)
		t.eq(util.toArgb(util.parseHexColor('#ff0000')), util.argb(255, 255, 0, 0))
	end)
